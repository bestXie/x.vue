<template>
    <div class="index-wrapper">
        ...
        <div class="scroll-content">
            ...
            <vDialog :vDialog="vDialog">
                <div slot="body">
                    <itemDetails :resolve="vDialog"></itemDetails>
                </div>
            </vDialog>
        </div>
    </div>
...
<script>
    ...
    import {get_yellow_pages_list, get_yellowPage_service_search} from '../../api/index.js';
    export default {
        data: function () {
            return {
                searchBoxTop: false,
        ...
        methods: {
            ...
            openItemDetail (data, name) {
                data = data || {};
                data.typeName = name;
                this.vDialog.data = data;
                this.vDialog.isShow = true;
            },
            goAnchor(selector) {
